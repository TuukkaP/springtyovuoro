                        ...
                        <tbody>                 
                            <f:form method="put" action="${pageContext.request.contextPath}/admin/place/edit" modelAttribute="place">
                                ...
                                <tr>
                                    ...
                                    <td><f:input path="address" cssClass="form-control" placeholder="Osoite"></f:input></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><f:checkboxes path="bannedUsers" items="${userList}" multiple="true" itemValue="username" delimiter="&emsp;"/></td>
                                </tr>
                                <tr>
